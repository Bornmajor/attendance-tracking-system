...
<div class="img_container"><!--img_container-->
    <img src="images/bye.jpg" width='100%' alt="Hello">
</div><!--img_container-->

<div class="check_in_fm"><!--checkin-->
<form action="" method="post" id='form_check_out'>
     
    <div class="alert alert-dark" role="alert">
     Use the form below to end your day session
    </div>
    ...
    <div class="mb-3">
        <button type="submit" style='width:100%;' class='btn btn-primary'>End session</button>
